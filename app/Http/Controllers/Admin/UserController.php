...
class UserController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin.users.index')->with('success','Cambio realizado con éxito'); 
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin.users.index')->with('warning','El usuario no puede ser eliminado'); 
    }
}
