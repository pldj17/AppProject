    ...
    @if (auth()->user())
      ...
      <li class="nav-item dropdown show-noti">
        <a class="nav-link" data-toggle="dropdown" href="#">
          ...
          <span class="badge-warning navbar-badge number-alert">{{$numberAlert}}</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <span class="dropdown-item dropdown-header number-message">{{$numberAlert}} Notifications</span>
