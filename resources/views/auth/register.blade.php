...
<html>
    ...
    <div class="register-logo">
        <a href="{{asset("assets/$theme/index2.html")}}"><b>Admin</b>LTE</a>
    </div>
    ...
    <div class="card">
        ...
        <form role="form" method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group{{ $errors->has('date') ? ' has-danger' : '' }}">
                <div class="input-group-alternative mb-3">
                    <input type="date" name="date_born" max="3000-12-31" min="1000-01-01" class="form-control @error('date') is-invalid @enderror" name="date_born" value="{{ old('date_born') }}"  autocomplete="date_born">
